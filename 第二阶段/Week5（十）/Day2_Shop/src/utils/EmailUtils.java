...
public class EmailUtils {
	public static void sendEmail(User user){
		//发送方
		String myAccount = "13480743727@163.com";
		//授权码
		String myPass = "dsx123456";
		//发件人 邮箱的 SMTP 服务器地址
		...
		MimeMessage message = createMsg(session,myAccount,user);	//创建一个邮件
		//4.利用Transport 发送邮件
		try {
	...
	private static MimeMessage createMsg(Session session, String myAccount, User user) {
		//使用session对象（存入了服务器的数据） 获取待发送的邮件信息
